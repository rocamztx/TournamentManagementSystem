...
class CaboGuerraTelaoView extends StatefulWidget {
  const CaboGuerraTelaoView({super.key});

  @override
  State<CaboGuerraTelaoView> createState() => _CaboGuerraTelaoViewState();
}

class _CaboGuerraTelaoViewState extends State<CaboGuerraTelaoView> {
  ...
  void _publishBracketState() {
    // Telão é apenas leitura, não publica estado.
  }
